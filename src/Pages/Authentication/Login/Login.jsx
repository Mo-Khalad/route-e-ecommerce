...
import img from "../../../images/sginin-image2.png";
          ...
          <div className="w-100 h-50 d-flex flex-wrap justify-content-center my-5">
            <Col md={6} sm={12} xs={12}>
              <div className="w-50 m-5 m-auto mt-5">
                ...
                <FormComponentBM
                  ...
                  method={"post"}
                  inputStyle={`input w-100 p-1 m-2 field`}
                  success={"../"}
                  btn={"login"}
                />
                <Link className="link text-dark ms-3 " to={"../register"}>Create a new account</Link>
                ...
                <button className="px-4 py-1 facebook_btn border-0 text-black ">
                  <img src={iconGoogle} alt="icon-google" width={20} /> Sign Up
                  With Google
                </button>
              </div>
            </Col>
            <Col md={6} sm={12} xs={12}>
             <div
              ...
              >
                <img className={"mt-1 mb-5"} src={img} alt="img" width={450} />
              </div>
            </Col>
          </div>
        </Col>
