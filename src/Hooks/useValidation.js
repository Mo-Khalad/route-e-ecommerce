...
export const useValidation = ()=>{
 ...
 const email = Yup.string().matches(/^[a-zA-Z0-9._%+-]+@[a-zA-Z.-]+\.[a-zA-Z]{2,}$/, "Invalid email" ).required("required")
 const password= Yup.string().matches(/^[a-zA-Z0-9-@]{6,}$/, "Please provide a valid password").required("required");
